...
namespace Gtk {
    ...
    public partial class GtkSharpBuilder : Gtk.Builder {
		...
		public GtkSharpBuilder (System.IO.Stream s) : this (s, null)
		{
		}
		
        public GtkSharpBuilder (System.IO.Stream s, string translation_domain)
		{
			if (s == null)
        ...
        public GtkSharpBuilder (string resource_name) : this (Assembly.GetCallingAssembly (), resource_name, null)
		{
		}
		
        public GtkSharpBuilder (string resource_name, string translation_domain)
			: this (Assembly.GetCallingAssembly (), resource_name, translation_domain)
		{
		}
		
        public GtkSharpBuilder (Assembly assembly, string resource_name, string translation_domain) : this ()
		{
