    ...
    public class EmoticonsWindow : Gtk.Window
    {
            ...
            : base(Gtk.WindowType.Popup)
        {
            ...
            foreach (var emoticon in EmoticonStore) {
                emoticonButtonImageList.Add(new EmoticonButton(this, Entry, emoticon.Key, EmoticonStore.GetEmoticonImage(emoticon.Value, 24), emoticon.Value));
                emoticonButtonSymbolList.Add(new EmoticonButton(this, Entry, emoticon.Key, emoticon.Value));
            }
            ...
            imageTabLabel.Pixbuf = EmoticonStore.GetEmoticonImage("smile", 24);
            var font = Pango.FontDescription.FromString("Serif Bold 24");
            symbolTabLabel.ModifyFont(font);
