...
namespace Smuxi.Frontend.Gnome
{
    public class EmoticonStore : Dictionary<string, string>
    {
        ...
        public Gdk.Pixbuf GetEmoticonImage(string emoticonName, int size = 16 )
        {
            var emoticonImage = Frontend.LoadIcon("face- " + emoticonName + "-symbolic", size, "face-" + emoticonName + "-symbolic_256x256.png");
