...
namespace Smuxi.Engine
{
    ...
    public class SmartLink
    {
        ...
        public EMessagePartModel Type { get; set; }
    };
    public class MessageBuilderSettings
    {
        public List<SmartLink> SmartLinks { get; private set; }
        
        void CreateSmartLink(Regex regex, string linkPattern = null, string textPattern = null)
        {
            var link = new SmartLink();
            link.Regex = regex;
            link.LinkPattern = linkPattern;
            link.TextPattern = textPattern;
            link.Type = EMessagePartModel.Url;
            SmartLinks.Add(link);
        }
        
        void CreateSmartText(Regex regex, string textPattern = null)
        {
            var link = new SmartLink();
            link.Regex = regex;
            link.TextPattern = textPattern;
            link.Type = EMessagePartModel.Text;
            SmartLinks.Add(link);
        }
