...
namespace Smuxi.Engine
{
    public static class TextColorPalettes
    {
        ...
        public static List<TextColor> Xterm256 { get; set; }
        ...
        static TextColorPalettes() {
            ...
            Xterm256 = new List<TextColor>(256);
            Xterm256.AddRange(LinuxConsole);
            foreach (var hexColor in xtermColors) {
                Xterm256.Add(TextColor.Parse(hexColor));
            }
        }
    }
}
